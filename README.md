...
- Light/dark mode toggle with `localStorage` persistence and no-flash on load
- Fully responsive mobile layout with hamburger nav
- Image lightbox galleries (ARISE internship photos, keyboard builds)
